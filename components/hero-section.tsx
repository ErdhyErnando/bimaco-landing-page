...
import bimacoHero from "./../public/bimaco-hero.webp";

export default function HeroSection() {
  return (
    <section className="w-full max-w-7xl mx-auto py-20 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between">
      <div className="w-full md:w-1/2 space-y-6">
        <div className="space-y-2">
          <h1 className="text-5xl md:text-6xl font-bold font-raleway">
            Kopi Premium
          </h1>
          <h2 className="text-2xl md:text-3xl font-raleway">
